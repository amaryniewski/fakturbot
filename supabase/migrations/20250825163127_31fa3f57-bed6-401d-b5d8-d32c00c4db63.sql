...
DROP POLICY IF EXISTS "Users can manage their own parsed data" ON parsed_data;
CREATE POLICY "Users can manage their own parsed data" ON parsed_data
    FOR ALL USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Service role can manage all parsed data" ON parsed_data;
CREATE POLICY "Service role can manage all parsed data" ON parsed_data
...
DROP POLICY IF EXISTS "Users can manage their own KSeF config" ON ksef_config;
CREATE POLICY "Users can manage their own KSeF config" ON ksef_config
    FOR ALL USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Service role can manage all KSeF configs" ON ksef_config;
...
DROP POLICY IF EXISTS "Users can view their own operations" ON ksef_fetch_operations;
CREATE POLICY "Users can view their own operations" ON ksef_fetch_operations
    FOR SELECT USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Service role can manage all operations" ON ksef_fetch_operations;
...
DROP POLICY IF EXISTS "Users can view their own invoice registry" ON ksef_invoice_registry;
CREATE POLICY "Users can view their own invoice registry" ON ksef_invoice_registry
    FOR SELECT USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Service role can manage all invoice registry" ON ksef_invoice_registry;
...
DROP POLICY IF EXISTS "Users can view their own error logs" ON ksef_error_logs;
CREATE POLICY "Users can view their own error logs" ON ksef_error_logs
    FOR SELECT USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "System can manage error logs" ON ksef_error_logs;
