-- Fix insert_encrypted_fakturownia_connection to use proper function path
DROP FUNCTION IF EXISTS public.insert_encrypted_fakturownia_connection(uuid, text, text, text);
