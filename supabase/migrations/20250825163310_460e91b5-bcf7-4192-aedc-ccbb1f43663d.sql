-- Naprawianie ostrzeżeń bezpieczeństwa KSeF - poprawka
...
-- 3. Dodanie bezpiecznej funkcji dostępu do statystyk
CREATE OR REPLACE FUNCTION get_user_ksef_stats_secure(p_user_id UUID DEFAULT NULL)
RETURNS TABLE (
    user_id UUID,
